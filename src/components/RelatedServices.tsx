...
const RELATED: Record<string, string[]> = {
  ...
  'wedding-dj-nyc-nj':             ['wedding-dj-manhattan-nyc', 'wedding-dj-northern-nj', 'rb-hip-hop-dj-nyc-nj', 'afrobeats-amapiano-dj-nyc-nj'],
  'wedding-dj-manhattan-nyc':      ['wedding-dj-nyc-nj', 'wedding-dj-long-island-ny', 'hamptons-luxury-dj', 'piano-dj-duo-nyc-nj'],
